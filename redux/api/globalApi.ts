...
export const globalApi = createApi({
    ...
    endpoints: (builder) => ({
        ...
        // Category
        getCategories: builder.query<GlobalResponse<Category>, void>({
            query: () => '/global/category',
        }),
        ...
        // Chats
        getChats: builder.query<GlobalResponse<Chat>, void>({
            query: () => '/global/chats',
        }),
        ...
        updateChat: builder.mutation<Chat, { uid: string; body: any }>({
            query: ({ uid, body }) => ({
        ...
        patchChat: builder.mutation<Chat, { uid: string; body: any }>({
            query: ({ uid, body }) => ({
                url: `/global/chats/${uid}`,
                method: 'PATCH',
                body,
        ...
        getChatThreads: builder.query<GlobalResponse<ChatThread>, string>({
            query: (uid) => `/global/chats/${uid}/threads`,
        }),
        createChatThread: builder.mutation<any, { uid: string; body: { content: string; files?: string[] } }>({
            query: ({ uid, body }) => ({
        ...
        // Contents
        getContents: builder.query<GlobalResponse<Content>, void>({
            query: () => '/global/contents',
        }),
        ...
        createSizeFilter: builder.mutation<Filter, { title: string; description: string; code: string }>({
            query: (body) => ({
