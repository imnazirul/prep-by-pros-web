...
const CountryDropdownComponent = (
  ...
  const triggerClasses = cn(
    'flex w-full items-center justify-between whitespace-nowrap text-lg font-medium placeholder:text-black-7 cursor-pointer disabled:cursor-not-allowed disabled:opacity-50 [&>span]:line-clamp-1',
    slim === true && 'w-20',
  );
